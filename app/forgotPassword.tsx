    ...
    return <>
        <View style={{ backgroundColor: '#FFFFFF', flex: 1, alignItems: 'center', paddingHorizontal: 28, }}>
            ...
            <View style={{ justifyContent: 'flex-start', marginTop: 32, marginBottom: 68, gap: 12 }}>
                <Text style={{ fontFamily: 'RobotoMedium', fontSize: 24, color: '#191D23', }}>Forgot Password</Text>
            ...
            <View style={{ width: '100%', marginVertical: 40 }}>
                <TouchableOpacity style={styles.login_btn}>
                    <Text style={{ fontFamily: 'RobotoMedium', fontSize: 16, color: '#FEFEFE', }}>Submit</Text>
                </TouchableOpacity>
            </View>

            <View style={styles.link_container}>
                <Text style={{ fontFamily: 'RobotoRegular', fontSize: 14, color: ' #191D23', }}>Remembered password?</Text>
                <Link href={'/'}><Text style={{ color: '#1443C3', fontFamily: 'RobotoRegular', fontSize: 14, alignContent: 'center', }}>
